       ...
       ";
        ...
        $sql = mysqli_query($Open, "select DISTINCT 
                                        ...
                                        from tb_inputcrm a
                                           ...
                                           left join tb_inputdeviasi c on a.id_crm = c.id_crm
                                           left join master_deviasi d on c.id_deviasi = d.id_masterdeviasi
        ...
        $filename = "Rekap Document Deviasi Periode $startDate-$endDate.xls";
        $obj = new PHPExcel();
        ...
        $obj->setActiveSheetIndex(0)
            ->mergeCells('A1:K1')
            ->setCellValue("A1", "REKAP DOCUMENT DEVIASI")
