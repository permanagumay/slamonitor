...
if(isset($_GET['idCrm']) && isset($_SESSION['nik'])){
    $idCrm = $_GET['idCrm'];
    $sql = mysqli_query($Open, "select a.cabang,c.nama_marketing,a.nama_debitur, a.cif, a.ppk, a.crm, a.tgl_terimacrm
                                           from tb_inputcrm a 
        ...
        <div class="tab-content">
                            ...
                            <div class="box-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    while ($rowAgunan = mysqli_fetch_array($sqlAgunan)) {
                                        /* $tglCreate = date_create($rowAgunan[8]);
                                        ...
                                        if($rowAgunan[4] == '0000-00-00'){
                                            $HGBDate = '';
                                        }else {
                                            $HGBDate = $rowAgunan[4];
                                        }
                                        if($rowAgunan[9] == '0000-00-00'){
                                            $tglPenyelesaian = '';
                                        }else {
                                            $tglPenyelesaian = $rowAgunan[9];
                                        }
                                            ...
                                            <div class="box-body">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group" id="divAgunanLainnya">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input class="form-control" id="agunanLainnya" name="agunanLainnya" placeholder="agunan lainnya">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <select class="form-control" id="selectPengikatan" name="jenisPengikatan" onchange="showPengikatanLainnya()">
                                                                <?=getMasterPengikatan(); ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="box-body">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" id="idCrmCovNote"
                                                               name="idCrmCovNote"
                                                               value="<?= $idCrm ?>">
                                                    </div>
                                                    <div class="form-group">
                                            ...
                                            <div class="box-body">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group" id="divCovenantLainnya">
                                                        <label class="col-sm-4 control-label" style="text-align: left"></label>
                                                        <div class="col-sm-8">
                                                            <input class="form-control" id="covenantLainnya" name="covenantLainnya" placeholder="covenant lainnya">
            ...
            <div id="pencairan" class="tab-pane fade">
                <div class="row">
                    <div class="col-md-12">
                        <div class="box-body">
                            <button class="btn btn-yahoo btn-large" data-toggle="modal" data-target="#modalPencairan">
                                Tambah Pencairan.
                            </button>
                        </div>
                    </div>
                        ...
                        <div class="box box-info">
                            <div class="box-body">
                                <table id="tablePencairan1" class="table table-bordered table-striped">
                                    ...
                                    $sqlPencairan = mysqli_query($Open, "select id_pencairan,tgl_pencairan
                                                                             from tb_inputpencairan where id_crm = '$idCrm'");
                                    $no = 0;
                ...
                <!-- Start Modal Pencairan -->
                <div class="modal fade" id="modalPencairan" data-keyboard="false" data-backdrop="static" role="dialog">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header" style="background-color: #ccccff">
                                <h4><b>Input Tgl. Pencairan</b></h4>
                            </div>
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <p class="pencairanStatus"></p>
                                        <form role="form" action="#" class="form-horizontal" id="form-pencairan" enctype="multipart/form-data">
                                            <div class="box-body">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label class="col-sm-4 control-label" style="text-align: left">Tgl. Pencairan</label>
                                                        <div class="col-sm-8">
                                                            <div class="input-group input-append date" id="datePickerTglPencairan">
                                                                <input class="form-control" id="TglPencairan" name="TglPencairan" placeholder="yyyy/mm/dd"/>
                                                                <span class="input-group-addon add-on"><span class="glyphicon glyphicon-calendar"></span></span>
                                                            </div>
                                                            <input type="hidden" name="idCrmPencairan" value="<?=$idCrm?>">
                                                            <p class="tglPencairanStatus"></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-yahoo pull-right submitPencairan"
                                        onclick="sentPencairan()">Submit
                                </button>
                                <button type="button" id="btnKembaliDeviasi"
                                        class="btn btn-facebook pull-right submitDeviasiKembali"
                                        onclick="window.location.reload()">Kembali/Cancel
...
<script>
        ...
        $(document).ready(function () {
            ...
            $('#datePickerTglPencairan').datepicker({
                autoclose: true,
                format: 'yyyy/mm/dd'
            });
        ...
        function sentAgunanForm() {
            ...
            if($('#selectAgunan').val() == 19){
                ...
                if ($('#agunanLainnya').val().trim() == '') {
                    $('.statusAgunanLain').html('<span style="color:red;">Agunan Lain Wajib Diisi.</span>');
                    $('#agunanLainnya').focus();
                    return false;
                }else {
        ...
        function sentPencairan() {
            if($('#TglPencairan').val().trim() == ''){
                $('.tglPencairanStatus').html('<span style="color:red;">Tgl. Pencairan Wajib Diisi.</span>');
                return false;
            } else {
                $('.tglPencairanStatus').html('<span style="color:red;"></span>');
            }

            $.ajax({
                url: "pages/legal/Pencairan/act-pencairan.php",
                method: "POST",
                data: $('#form-pencairan').serialize(),
                success: function (msg) {
                    if (msg == 'ok') {
                        $('.pencairanStatus').html('<span style="color:green; ">Tgl. Pencairan Telah Tersimpan.</p>');
                        $('.submitPencairan').attr("disabled", "disabled");
                        $('.modal-body').css('opacity', '.5');
                    } else if (msg == 'sql') {
                        $('.pencairanStatus').html('<span style="color:red;">Tgl. Pencairan Gagal Tersimpan.</p>');
                    } else {
                        $('.pencairanStatus').html('<span style="color:red;">Data Error.</p>');
                    }
                }
