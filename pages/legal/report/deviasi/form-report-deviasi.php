<div class="box box-body">
    <div class="content">
        <ul class="breadcrumb">
            <li class="active">Report Deviasi</li>
        </ul>
        <div class="row">
            <div class="col-md-12">
                <form action="cetak-report-deviasi.php" id="form-report-cov" class="form-horizontal" method="POST" enctype="multipart/form-data">
                    <div class="box-body">
