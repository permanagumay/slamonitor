<div class="box box-body">
    <div class="content">
        <ul class="breadcrumb">
            <li class="active">Report Jaminan Jatuh Tempo HGB</li>
        </ul>
        <div class="row">
            <div class="col-md-12">
                <form action="cetak-report-jaminan.php" id="form-report-cov" class="form-horizontal" method="POST" enctype="multipart/form-data">
                    <div class="box-body">
