<div class="box box-body">
    <div class="content">
        <ul class="breadcrumb">
            <li class="active">Report Asuransi Jatuh Tempo</li>
        </ul>
        <div class="row">
            <div class="col-md-12">
                <form action="cetak-report-asuransi.php" id="form-report-cov" class="form-horizontal" method="POST" enctype="multipart/form-data">
                    <div class="box-body">
