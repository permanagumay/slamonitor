                        ...
                        <div class="box-body">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control" id="selectAgunanFasUpdate" name="selectAgunanFasUpdate" disabled="disabled">
                                            <?php
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control" id="tipePlafondUpdate" name="tipePlafondUpdate" disabled="disabled">
                                            <?php
                                ...
                                <div class="form-group" id="divTipeLainnyaUpdate">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control" id="tipeLainnyaUpdate" name="tipeLainnyaUpdate" value="<?= $result[6] ?>" placeholder="tipe lainnya" disabled="disabled"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control" id="selectFasilitasUpdate" name="selectFasilitasUpdate" disabled="disabled">
                                            <?php
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input class="form-control" id="SeqFasilitasUpdate" name="SeqFasilitasUpdate" placeholder="seq. number facilites" value="<?=$seqCode?>" onkeyup="validAngka(this)" disabled="disabled"><!--onkeyup="validAngka(this)"-->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control" id="plafondFasUpdate" name="plafondFasUpdate" value="<?= $result[4]?>" onkeyup="validAngka(this)" disabled="disabled"/>
